...
<div class="content-wrapper">
    ...
    <form action="{{ route('postTambahTransaksi') }}" onsubmit="return subm();" id="form-transaksi" method="POST" name="tambahMenu-form" enctype="multipart/form-data">
    @else
    <form action="{{ route('postEditTransaksi') }}" onsubmit="return subm();" id="form-transaksi" method="POST" name="tambahMenu-form" enctype="multipart/form-data">
    @endif
